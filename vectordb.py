...
def create_vectordb_config(job_id: str, jwt_token) -> dict:
    ...
    embedding_function = OpenAIEmbeddingFunction(api_key=jwt_token, model_name=os.getenv("EMBEDDING_MODEL", "text-embedding-3-large"), api_base=os.getenv("OPENAI_BASE_URL"))
